class Salsa extends MoveableObject {
    ...
    y = 375;
    IMAGES_SALSA_LEFT = [
        "assets/graphics/6_salsa_bottle/salsa_bottle_on_ground/salsa_bottle_on_ground_1.png"
    ];
    IMAGES_SALSA_RIGHT = [
        "assets/graphics/6_salsa_bottle/salsa_bottle_on_ground/salsa_bottle_on_ground_2.png"
    ]
     ...
     */
    constructor(x) {
        super().loadImage("assets/graphics/6_salsa_bottle/salsa_bottle_on_ground/salsa_bottle_on_ground_1.png");
        this.x = x;
